...
export const eliminaralimento = async (req, res) => {
  try {
    ...
    console.error("Error al intentar eliminar el alimento:", error);
    res.status(500).json({ error: "Error interno del servidor al intentar eliminar el alimento", details: error.message });
  }
};
